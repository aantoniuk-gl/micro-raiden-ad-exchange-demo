...
public class DspBidCollector {
    ...
    public Bid collect() {
        ...
        monitoringService.logBusiness(bid.getAdid() + " won with price=" + bid.getPrice() + " TKN");
    ...
    private Bid getBidFromDsp(String impId, String dspUrl) {
        ...
        if (bid != null) {
            ...
            monitoringService.logBusiness("Received Bid from " + bid.getAdid() +
                    " with price=" + bid.getPrice() + " TKN");
        }
        return bid;
    }
}
